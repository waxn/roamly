...
urlpatterns = [
    ...
    path('api/track/lines/', views.trip_lines_api, name='trip_lines_api'),
    path('api/dwell/points/', views.dwell_points_api, name='dwell_points_api'),
    ...
    path('api/poi/delete/', views.poi_delete_api, name='poi_delete'),
    ...
    path('api/admin/valhalla-tiles/', views.valhalla_tiles_status_api, name='valhalla_tiles_status'),
    path('api/admin/valhalla-tiles/rescan/', views.valhalla_tiles_rescan_api, name='valhalla_tiles_rescan'),
