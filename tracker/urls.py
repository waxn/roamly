...
urlpatterns = [
    ...
    path('api/trips/<int:trip_id>/days/<str:date_str>/', views.trip_day_note_save, name='trip_day_note_save'),
    path('api/trips/<int:trip_id>/days/<str:date_str>/photos/', views.trip_day_note_photos, name='trip_day_note_photos'),
    path('api/trips/<int:trip_id>/days/<str:date_str>/delete/', views.trip_day_note_delete, name='trip_day_note_delete'),
